(function() {
      ...
      return this.evaluator.bind("keypress", __bind(function(e) {
        ...
        if (code === 13) {
          return $.post(path, {
            ...
            return this.evaluator.val("" + this.evaluator.val + " => " + object.object);
          }, this), 'json');
        }
      }, this));
    };
  ...
  Debugger = (function() {
    ...
    Debugger.prototype.fill_process_selector = function() {
      ...
      $.get("" + this.server + "/errors", function(errors) {
        return $(errors).each(function(e) {
          return process_box.append("<option value='" + e.process_id + "'>" + (escapeHTML(e.label)) + "</option>");
        });
      }, 'json');
      if (this.process_id != null) {
        $.get("" + this.server + "/process/" + this.process_id, function(p) {
