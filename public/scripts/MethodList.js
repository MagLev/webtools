...
//              console.log(data);
                ...
                $.each(data.list, function(index, value){
                        ...
                        items.push('<td class="dict" title="' + GemStone.encodeHTML(value.dict) + '">' + GemStone.encodeHTML(value.dict) + '</td>');
                        items.push('<td class="klassCat" title="' + GemStone.encodeHTML(value.klassCat) + '">' + GemStone.encodeHTML(value.klassCat) + '</td>');
                        items.push('<td class="klass" title="' + GemStone.encodeHTML(value.klass) + '">' + GemStone.encodeHTML(value.klass) + '</td>');
                        items.push('<td class="category" title="' + GemStone.encodeHTML(value.category) + '">' + GemStone.encodeHTML(value.category) + '</td>');
                        items.push('<td class="selector" title="' + GemStone.encodeHTML(value.selector) + '">' + GemStone.encodeHTML(value.selector) + '</td></tr>');
                });
